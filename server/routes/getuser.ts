...
export const ensureSecureCookieConfig = (req: Request, res: Response, next: NextFunction) => {
...
router.get("/info", ensureClient, ensureSecureCookieConfig, (req: Request, res: Response) => {
...
// Route for logout
router.get("/logout", ensureClient, ensureSecureCookieConfig, (req: Request, res: Response) => {
